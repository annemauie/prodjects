    ...
    mydiv.innerHTML = `<h1 class="title2">${title2}</h1>
                            <div class="container">
                                <ul class="column1">
                                    ...
                                    <li><button class="btn1"><a href = "https://annemauie.github.io/dogging/">${button1}</a></button></li>
                                </ul>
                                <ul class="column2">
                                ...
                                <ul class="column3">
                                    ...
                                    <li><button class="btn1"><a href = "https://annemauie.github.io/queensprod/">${button3}</a></button></li>
                                </ul>
                            </div>
                        `
